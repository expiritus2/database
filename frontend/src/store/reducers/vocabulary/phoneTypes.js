...
import {
    getVocabularyPhoneTypesAction,
    saveVocabularyPhoneTypeAction,
    deleteVocabularyPhoneTypeAction,
    updateVocabularyPhoneTypeAction,
    saveVocabularyPhoneTypesAction,
...
export default handleActions({
    ...
    [saveVocabularyPhoneTypesAction]: (state, { payload }) => ({
        state: get(payload, 'state', initialData.state),
        data: get(payload, 'data', initialData.data),
        meta: get(payload, 'meta', initialData.meta),
    }),
